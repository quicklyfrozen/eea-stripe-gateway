...
function espresso_stripe_gw_disable_notice() {
    echo '<div class="error"><p>' . sprintf(__( 'The %sStripe Gateway%s plugin was deactivated! This plugin requires the %sMultibyte String, JSON and CURL PHP% extensions to be active on your server.' , 'event_espresso' ), '<strong>', '</strong>', '<strong>', '</strong>') . '</p></div>';
}
