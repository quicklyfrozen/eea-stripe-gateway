jQuery(document).ready( function($) {
    ...
    EEG_STRIPE_CONNECT = {
                ...
                if (button_container && submitting_form) {
                    ...
                    setTimeout(function () {
                        $(EEG_STRIPE_CONNECT.oauth_window.document.body).html(
                            ...
                            '<link rel="stylesheet" type="text/css" href="' + EEG_STRIPE_CONNECT_ARGS.espresso_default_styles + '">' +
                        ...
                        var win_loader = EEG_STRIPE_CONNECT.oauth_window.document.getElementById('espresso-ajax-loading');
                    ...
                    EEG_STRIPE_CONNECT.submitted_pm = button_container.attr('id').replace(/eeg_stripe_connect_|eeg_stripe_disconnect_/, '');
        ...
        /**
         * @function update_connect_button_text
         */
        ...
        /**
         * @function update_disconnect_section
         */
        ...
        oauth_send_request: function(request_action) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response == null || response['stripe_error']
                        ...
                        if (EEG_STRIPE_CONNECT.oauth_window) {
                            EEG_STRIPE_CONNECT.oauth_window.document.getElementById('espresso-ajax-loading').style.display = 'none';
